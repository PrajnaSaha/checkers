...
class jump
{
    ...
    prev(p), pieceJump(jpingp), noNext(true), numTimes(0), c(piece), xs(xs), ys(ys),
...
void board::whoComputer()
{
    ...
    while (b)
    {
        ...
        if (tolower(c) == 'y')
        {
            ...
            b = false;
            int algo = 1;
            cout << "Choose algorithm for player 1: " << endl;
            ...
            int option;
            cout << "Choose Evaluation Function for Player 1:" << endl;
    ...
    while (b)
    {
        ...
        if (tolower(c) == 'y')
        {
            ...
            b = false;
            int algo = 1;
            cout << "Choose algorithm for player 2: " << endl;
            cout << "1: MINIMAX-A-B" << endl;
            cout << "2: ALPHA BETA SEARCH" << endl;
            cout << "Enter option 1 or 2 " << endl;
            cin >> algo;
            ...
            int option;
            cout << "Choose Evaluation Function for Player 2:" << endl;
            cout << "1: Evaluation function 1" << endl;
            cout << "2: Evaluation function 2" << endl;
            cout << "3: Evaluation function 3" << endl;
            cout << "Enter option 1, 2, or 3" << endl;
...
void board::createJumpMove(list<jump*>& jlist)
{
    if (!jlist.empty())
    {
        ...
        for (; it != jlist.end(); ++it)
        {
            if ((*it)->noNext)
            {
                move* m = new move((*it)->pieceJump, -1, -1, -1, -1);
                jump* jp = (*it);
                while (jp != NULL)
                {
